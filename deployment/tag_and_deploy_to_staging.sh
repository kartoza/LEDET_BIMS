...
then
    ...
    rsync -L  backups/latest.dmp staging.healthyrivers.kartoza.com:/home/healthyrivers/deployment/backups/
    rsync -r -v media/ staging.healthyrivers.kartoza.com:/home/healthyrivers/deployment/media
	...
	ssh staging.healthyrivers.kartoza.com "cd /home/healthyrivers/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
